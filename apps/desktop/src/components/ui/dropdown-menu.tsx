...
>(({ className, ...props }, ref) => (
  // Portal is required: without it the submenu is clipped by any ancestor
  // overflow container (e.g. ScrollArea viewport, DropdownMenuContent itself).
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        "frosted-panel glass-noise shadow-dialog",
